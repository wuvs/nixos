...

{
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      monitor = [
        { output = host.monitor; mode = host.mode; position = "0x0"; scale = 1; }
      ];
      ...
      workspace_rule = [
        { workspace = "1"; monitor = host.monitor; persistent = true; default_name = "web"; }
        { workspace = "2"; monitor = host.monitor; persistent = true; default_name = "code"; }
        { workspace = "3"; monitor = host.monitor; persistent = true; default_name = "chat"; }
        { workspace = "4"; monitor = host.monitor; persistent = true; default_name = "game"; }
        { workspace = "5"; monitor = host.monitor; persistent = true; default_name = "design"; }
      ];
